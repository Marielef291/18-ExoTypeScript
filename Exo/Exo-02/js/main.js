...
const product1 = { idProduct: 1, nameProduct: 'Laptop', priceProduct: 1000, stockProduct: 5 };
const product2 = { idProduct: 2, nameProduct: 'Phone', priceProduct: 500, stockProduct: 10 };
...
const customer1 = { idCustomer: 1, nameCustomer: 'John Doe', emailCustomer: 'john@example.com' };
console.log(`Client créé : ${customer1.nameCustomer}, Email : ${customer1.emailCustomer}\n`);
// Création d'articles de commande
const item1 = { product: product1, quantity: 1 };
const item2 = { product: product2, quantity: 2 };
